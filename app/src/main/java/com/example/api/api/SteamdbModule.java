...
public class SteamdbModule {
    static SteamdbAPI steamdbAPI;

    public static SteamdbAPI getAPI(){
        if(steamdbAPI == null){
            ...
            steamdbAPI = retrofit.create(SteamdbAPI.class);
        }
        return steamdbAPI;
    }
}
...
class ApiKeyInterceptor implements Interceptor {
    ...
    public okhttp3.Response intercept(Chain chain) throws IOException {
        ...
        HttpUrl url = originalHttpUrl.newBuilder()
                .addQueryParameter("key", "8008AAB477E3F32435D95C7D0E02E58F")
                .addQueryParameter("steamid", "76561198142650530")
                .build();
